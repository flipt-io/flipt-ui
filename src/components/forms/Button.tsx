  ...
  return (
    <button
      ...
      className={classNames(
        ...
        `${className} mb-1 inline-flex items-center justify-center rounded-md border px-4 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-1 focus:ring-offset-1 sm:w-auto`,
      )}
      disabled={disabled}
    >
      {children}
