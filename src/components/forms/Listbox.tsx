      ...
      {({ open }) => (
        <>
          <div className="relative mt-2">
            <L.Button
              className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-1 focus:ring-violet-600 sm:text-sm sm:leading-6"
              id={`${id}-select-button`}
            >
              <span className="block truncate">{selected?.displayValue}</span>
